...
const textPrompt = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let result;
    try {
        result = yield chat.sendMessageStream(req.body.prompt);
    }
    catch (e) {
        console.log(e);
    }
...
const textImagePrompt = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let history = [
        { role: ROLE.role, parts: [{ text: req.body.messages }] },
    ];
    let chatSesssion = main_1.initializeVertex.visionGModel.startChat({ history });
    if (req.file) {
